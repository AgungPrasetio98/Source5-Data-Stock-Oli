<?php
$no=$_GET['no'];
$ambil=  mysqli_query($koneksi, "SELECT * FROM tbl_ahm WHERE no ='$no'") or die ("SQL Edit error");
        ...
        <div class="col-xs-12">
            <div class="panel panel-warning">
                ...
                <div class="panel-footer">
                    <a href="?page=ahm&actions=tampil" class="btn btn-danger btn-sm">
...
if($_POST){
    ...
    //buat sql
    $sql="UPDATE tbl_ahm SET sisa='$sisa',oli_masuk='$oli_masuk',oli_keluar='$oli_keluar',selisih='$selisih' WHERE no ='$no'"; 
