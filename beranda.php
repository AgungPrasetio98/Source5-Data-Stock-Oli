    ...
    <div class="row">
        <div class ="col-xs-12">
            ...
            <div class="alert alert-warning">
                <strong><marquee>Selamat Datang di Sistem Informasi Stock Oli pada PT. AKA Honda Kisaran</marquee></strong>
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-sm-9 col-xs-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Data Stock Oli pada PT. AKA Honda Kisaran</h3>
                </div>
                <div class="panel-body">
                     <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>No.</th><th width="30%">Id Oli</th><th>Jenis Oli</th><th>Merk</th><th>Harga</th>
                            </tr>
                        </thead>
                        <tbody>
        ...
        <div class="col-sm-3 col-xs-12">
            ...
            <div class="alert alert-warning">
                <strong>Welcome <?=$_SESSION['nama_lengkap']?></strong>
            </div>
            <?php
           } else { ?>
