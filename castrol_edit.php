<?php
$no=$_GET['no'];
$ambil=  mysqli_query($koneksi, "SELECT * FROM tbl_castrol WHERE no ='$no'") or die ("SQL Edit error");
        ...
        <div class="col-xs-12">
            <div class="panel panel-warning">
                ...
                <div class="panel-footer">
                    <a href="?page=castrol&actions=tampil" class="btn btn-danger btn-sm">
...
if($_POST){
    ...
    //buat sql
    $sql="UPDATE tbl_castrol SET sisa='$sisa',oli_masuk='$oli_masuk',oli_keluar='$oli_keluar',selisih='$selisih' WHERE no ='$no'"; 
    $query=  mysqli_query($koneksi, $sql) or die ("SQL Edit MHS Error");
    if ($query){
        echo "<script>window.location.assign('?page=castrol&actions=tampil');</script>";
    }else{
