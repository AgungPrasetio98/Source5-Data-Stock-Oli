    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="panel panel-warning">
				...
				<br>
                    <h3 class="panel-title"><span class="fa fa-user-plus"></span>Laporan Data Stock Oli Federal</h3>
                </div>
                <div class="panel-body">
                    <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        ...
                        <tfoot>
                            <tr>
                                <td colspan="9">
                                    <a href="report/federal_semua.php" target="_blank" class="btn btn-info btn-sm">
