            ...
            <div class='row'>
                <div class="col-sm-12">
                    ...
                    <div class="text-center">
                        <h2>Sistem Informasi Data Stock Oli Jenis Federal pada PT. AKA Honda Kisaran </h2>
                        <h4>Jl. SM. Raja No. 350, Kisaran Barat, Kec. Kota Kisaran barat<br>
                              Kabupaten Asahan, Sumatera Utara, Kode Pos : 21211</h4>
                        <hr>
                        <h3>DATA SELURUH STOCK OLI JENIS FEDERAL</h3>
