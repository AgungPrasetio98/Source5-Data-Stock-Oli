<?php
$no=$_GET['no'];
$ambil=  mysqli_query($koneksi, "SELECT * FROM tbl_mesran WHERE no ='$no'") or die ("SQL Edit error");
...
if($_POST){
    ...
    //buat sql
    $sql="UPDATE tbl_mesran SET sisa='$sisa',oli_masuk='$oli_masuk',oli_keluar='$oli_keluar',selisih='$selisih' WHERE no ='$no'"; 
